//4.Cart html'i nereye listeliyeceksek oraya aktarmam gerekiyor.Nereye listelenecek bu eleman?html'deki menu-list içinemenü lis
const elements= {
...
//3.Datayı  aktardıktan sonra elimdeki veriyialıp arayüzde renderlamam gerekiyor.Menü elemalarını render eden fonksiyon
const renderCards = (data) => {
    //Data dizisine dön ve her leeman için bir html oluştur.
   const cardsHtml = data.map((item)=>`
    
    <a href='./detail.html?id=${item.id}' class="d-flex flex-column text-decoration-none flex-md-row text-dark gap-3" id="card">
        <img
    ...
    //oluşturulan html' menu list içerisine ata.
...
//7.Detay sayfasını render eden function. Bu fonksiyondan beklşentim; kendisine hangi ürürünün detay sayfasına gittiysem aktarayım o da benim için html'ni oluştursun.

const renderDetailPage = (product, outlet) =>{
   // Bu fonksiyona verilen outlet parametresinin içeriğini belirle
 ...
 <h4 class="mt-4">
   Ürünün Fiyatı:<span class="text-success">${(product.price * 30).toFixed(
     2
   )} ₺</span>
 </h4>
...
//8. Ürün bulunamadığında renderlama yapacak fonksiyon
